...
public class BooksClient {
	public static void main(String[] args) {
		...
		while(i == 1) {
			...
			System.out.println("Enter 5 : To get books by title");
			System.out.println("Enter 6 : To get books by a publisher");
			System.out.println("Enter 7 : To update the publisher of a  book");
			...
			case 4: System.out.println("Enter a price");
					...
					break;
			case 5: System.out.println("Enter title or part of it");
					title = sc.next();
					BooksList.getBooksByTitle(title);
					break;
			case 6: System.out.println("Enter publisher");
					publisher = sc.next();
					BooksList.getBooksByPublisher(publisher);
					break;
			case 7: System.out.println("Enter title and new publisher");
					title = sc.next();
					publisher = sc.next();
					BooksList.updatePublisher(title, publisher);
					break;
			case 8: i = 0;
					break;
